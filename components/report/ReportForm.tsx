  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="relative group">
        ...
        <label
          ...
          className="block w-full p-8 border-2 border-dashed border-zinc-700 rounded-2xl 
                   hover:border-purple-500/80 hover:bg-sky-500/5 transition-all duration-200
      ...
      <div>
        ...
        <select title="select report type"
      ...
      <button
        ...
        className="w-full relative group overflow-hidden rounded-xl bg-gradient-to-br from-sky-600 to-purple-500 
